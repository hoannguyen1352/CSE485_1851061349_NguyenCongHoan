    ...
    <div class="row">
        <div class="col-md-3 a">
            ...
            <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <a href="home-page.php" class="nav-link">BackHome</a>
            </div>
        </div>
                    ...
                    <form action="test2.php" method="POST">
                        <div class="profile-content">
                            <div class="form-group">
                                ...
                                <!-- <select name="a0"  class="form-control" id="sel_user">
                                    <option>None</option>
                                </select> -->
                            ...
                            <div class="form-group">
                                ...
                                <button type="button" class="btn btn-secondary" id="btn"><a href="test2.php">Close</a></button>
                            </div>
                        </div>
                    </form>
                </div>
