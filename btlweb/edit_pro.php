    ...
    <div class="row profile">
		<div class="col-md-3">
			<div class="profile-sidebar">
				...
				<div class="profile-userbuttons">
					...
					<button type="button" class="btn btn-danger btn-sm"><a href="edit_pro.php">Cancer</a></button>
				</div>
				</form>
				<!-- END SIDEBAR BUTTONS -->
				<!-- SIDEBAR MENU -->
		...
		<form method="POST" name="change-pro">
			<div class="col-md-8">
				...
				<button type="button" class="btn btn-secondary" id="btn"><a href="edit_pro.php">Cancer</a></button>
				</div>
				</div>
			</div>
		</form>
